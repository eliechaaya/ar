...
(function () {
    var games = [
	  ...
	  { img: 'img/bg-animals.png', color: '#ccecfb',  word: '',        sound: 'sounds/sounds/animals/',caption:'dog 🔊',caption_Ar:'حيوانات أليفة 🐕' ,voice:'sounds/sounds/cries/' },
       ...
       { img: 'img/dog'+i+'.gif', color: '#ccecfb',  word: 'dog',        sound: 'sounds/sounds/animals/dog',caption:'dog 🔊',caption_Ar:'كلب 🔊' ,voice:'sounds/sounds/cries/dog' },
		...
		{ img: 'img/goldfish.gif', color: '#ccecfb',  word: 'fish',   sound: 'sounds/sounds/animals/fish' ,caption:'fish 🔊',caption_Ar:'سمكة 🔊',voice:'sounds/sounds/cries/fish'  },
		
		
		{ img: 'img/pony.png', color: '#ccecfb',  word: 'pony',   sound: 'sounds/sounds/animals/pony' ,caption:'pony 🔊',caption_Ar:'مهر 🔊',voice:'sounds/sounds/cries/pony'  },
