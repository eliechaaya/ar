...
(function () {
    var games = [
	  ...
	  { img: 'img/bg-animals.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: '',        sound: 'sounds/sounds/animals/',caption:'dog 🔊',caption_Ar:'حيوانات المزرعة 🐄' ,voice:'sounds/sounds/cries/' },

	 { img: 'img/cow'+i+'.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'cow',         sound: 'sounds/sounds/animals/cow',caption:'cow 🔊',caption_Ar:'بقرة 🔊',voice:'sounds/sounds/cries/cow' },
	
		{ img: 'img/horse'+i+'.gif', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'horse',   sound: 'sounds/sounds/animals/horse',caption:'horse 🔊',caption_Ar:'حصان 🔊',voice:'sounds/sounds/cries/horse'  },
		
        { img: 'img/donkey'+i+'.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'donkey',  sound: 'sounds/sounds/animals/donkey',caption:'donkey 🔊',caption_Ar:'حمار 🔊' ,voice:'sounds/sounds/cries/donkey' },
		
		{ img: 'img/goat'+i+'.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'goat',      sound: 'sounds/sounds/animals/goat',caption:'goat 🔊',caption_Ar:'ماعز 🔊' ,voice:'sounds/sounds/cries/goat' },
		
		{ img: 'https://mir-s3-cdn-cf.behance.net/project_modules/disp/e7d81771805451.5ca68e4ac7166.gif', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'sheep 🔊',    sound: 'sounds/sounds/animals/sheep',caption:'sheep 🔊',caption_Ar:'خروف 🔊' ,voice:'sounds/sounds/cries/sheep' },
		
		{ img: 'img/chicken0.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'chicken', sound: 'sounds/sounds/animals/chicken',caption:'chicken  🔊',caption_Ar:'دجاجة 🔊' ,voice:'sounds/sounds/cries/chicken' },
		
      
		{ img: 'img/frog'+i+'.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'frog',       sound: 'sounds/sounds/animals/frog' ,caption:'frog 🔊',caption_Ar:'ضفدع 🔊',voice:'sounds/sounds/cries/frog'  },
		
		{ img: 'img/rabbit.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'rabbit',   sound: 'sounds/sounds/animals/rabbit' ,caption:'rabbit 🔊',
		caption_Ar:'أرنب 🔊',voice:'sounds/sounds/cries/rabbit'  },
		


		{ img: 'img/mole.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'mole',        sound: 'sounds/sounds/animals/mole' ,caption:'Mole 🔊',caption_Ar:'خلد 🔊',voice:'sounds/sounds/cries/mole'  }
