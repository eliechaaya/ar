...
(function () {
    var games = [
	  ...
	  { img: 'img/bg-animals.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: '',        sound: 'sounds/sounds/animals/',caption:'dog 🔊',caption_Ar:'عالم الطيور 🐥' ,voice:'sounds/sounds/cries/' },


                                      			
		{ img: 'img/parrot'+i+'.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'parrot',   sound: 'sounds/sounds/animals/parrot' ,caption:'parrot 🔊',caption_Ar:'ببغاء 🔊',voice:'sounds/sounds/cries/parrot'},
		...
		{ img: 'img/chicken0.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'chicken', sound: 'sounds/sounds/animals/chicken',caption:'chicken  🔊',caption_Ar:'دجاجة 🔊' ,voice:'sounds/sounds/cries/chicken' },
		 ...
		 { img: 'img/duck.gif', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'Duck',   sound: 'sounds/sounds/animals/duck',caption:'Duck 🔊',caption_Ar:'بطة 🔊',voice:'sounds/sounds/cries/duck' },
		 
		 { img: 'img/owl.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'owl',   sound: 'sounds/sounds/animals/owl' ,caption:'owl 🔊',caption_Ar:'بومة 🔊',voice:'sounds/sounds/cries/owl'},
		 
		 
		 { img: 'img/pigeon.gif', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'pigon',    sound: 'sounds/sounds/animals/pigeon',caption:'Pigeon 🔊',caption_Ar:'حمامة 🔊' ,voice:'sounds/sounds/cries/pigeon' },
		 
		 
		 { img: 'img/crow.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'crow',   sound: 'sounds/sounds/animals/crow' ,caption:'crow 🔊',caption_Ar:'غراب 🔊',voice:'sounds/sounds/cries/crow'},
		 
		 
		{ img: 'img/seagull.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'seagull',   sound: 'sounds/sounds/animals/seagull' ,caption:'Seagull 🔊',caption_Ar:'نورس 🔊',voice:'sounds/sounds/cries/seagull'},
		
		
		
		{ img: 'img/eagle.png', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'eagle',   sound: 'sounds/sounds/animals/eagle' ,caption:'eagle 🔊',caption_Ar:'نسر 🔊',voice:'sounds/sounds/cries/eagle'},
		
		
		{ img: 'img/ostrich.gif', color: 'linear-gradient(#71e6ff, #ffffff)',  word: 'ostrich',   sound: 'sounds/sounds/animals/ostrich' ,caption:'Ostrich 🔊',caption_Ar:'نعامة 🔊',voice:'sounds/sounds/cries/ostrich'}
