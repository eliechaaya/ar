...
(function () {
    var games = [
        { img: 'img/body.png', color: '#a7f1ac',  word: '', sound: 'sounds/' },
        { img: 'img/body1.png', color: '#f9c8eb',  word: '',   sound: 'sounds/body/body1' },
		{ img: 'img/body2.png', color: '#f8c9ca',  word: '',   sound: 'sounds/body/body2' },
		{ img: 'img/body3.png', color: '#e9ffd1',  word: '',   sound: 'sounds/body/body3' },
		{ img: 'img/body4.png', color: '#eed9cb',  word: '',   sound: 'sounds/body/body4' },
		{ img: 'img/body5.png', color: '#ffe6d4',  word: '',   sound: 'sounds/body/body5' },
		{ img: 'img/body6.png', color: '#e0e2f1',  word: '',   sound: 'sounds/body/body6' },
		{ img: 'img/body7.png', color: '#fbe5bd',  word: '',   sound: 'sounds/body/body7' },
		{ img: 'img/body8.png', color: '#ffd6fa',  word: '',   sound: 'sounds/body/body8' },
		{ img: 'img/body9.png', color: '#ffd6fa',  word: '',   sound: 'sounds/body/body9' },
		{ img: 'img/body10.png', color: '#ffd6fa',  word: '',   sound: 'sounds/body/body10' },
		{ img: 'img/body11.png', color: '#ffd6fa',  word: '',   sound: 'sounds/body/body11' },
		{ img: 'img/body12.png', color: '#ffd6fa',  word: '',   sound: 'sounds/body/body12' }
