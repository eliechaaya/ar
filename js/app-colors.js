...
(function () {
    var games = [
        { img: 'img/colors.png', color: '#a7f1ac',  word: '', sound: 'sounds/' },
        { img: 'img/red.png', color: '#f9c8eb',  word: '',   sound: 'sounds/colors/color1' },
		{ img: 'img/blue.png', color: '#f8c9ca',  word: '',   sound: 'sounds/colors/color2' },
		{ img: 'img/green.png', color: '#e9ffd1',  word: '',   sound: 'sounds/colors/color3' },
		{ img: 'img/yellow.png', color: '#eed9cb',  word: '',   sound: 'sounds/colors/color4' },
		{ img: 'img/orange.png', color: '#ffe6d4',  word: '',   sound: 'sounds/colors/color5' },
		{ img: 'img/purple.png', color: '#e0e2f1',  word: '',   sound: 'sounds/colors/color6' },
		{ img: 'img/white.png', color: '#fbe5bd',  word: '',   sound: 'sounds/colors/color7' },
		{ img: 'img/black.png', color: '#ffd6fa',  word: '',   sound: 'sounds/colors/color8' },
		{ img: 'img/brawn.png', color: '#ebffd5',  word: '',   sound: 'sounds/colors/color9' }
