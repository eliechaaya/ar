...
(function () {
    var games = [
        { img: 'img/days.png', color: '#a7f1ac',  word: '', sound: 'sounds/' },
        { img: 'img/monday.png', color: '#d5b2e4',  word: '',   sound: 'sounds/days/snd_monday' },
		{ img: 'img/tuesday.png', color: '#aae5ae',  word: '',   sound: 'sounds/days/snd_tuesday' },
		{ img: 'img/wednesday.png', color: '#adcfec',  word: '',   sound: 'sounds/days/snd_wednesday' },
		{ img: 'img/thursday.png', color: '#f8c9aa',  word: '',   sound: 'sounds/days/snd_thusday' },
		{ img: 'img/friday.png', color: '#aef3b5',  word: '',   sound: 'sounds/days/snd_friday' },
		{ img: 'img/saturday.png', color: '#ebf0b7',  word: '',   sound: 'sounds/days/snd_satday' },
		{ img: 'img/sunday.png', color: '#bcfaf2',  word: '',   sound: 'sounds/days/snd_sunday' }
