...
(function () {
    var games = [
        { img: 'img/months.png', color: '#a7f1ac',     word: '', sound: 'sounds/' },
        { img: 'img/يناير.png', color: '#d5b2e4',      word: '',   sound: 'sounds/months/snd_january' },
		{ img: 'img/فبراير.png', color: '#c8fdfa',     word: '',   sound: 'sounds/months/snd_february' },
		{ img: 'img/مارس.png', color: '#b4f1b8',       word: '',   sound: 'sounds/months/snd_march' },
		{ img: 'img/ابريل.png', color: '#f8e59d',   word: '',   sound: 'sounds/months/snd_april' },
		{ img: 'img/يونيو.png', color: '#b6caec',     word: '',   sound: 'sounds/months/snd_june' },
		{ img: 'img/يوليو.png', color: '#eeaeec',   word: '',   sound: 'sounds/months/snd_july' },
		{ img: 'img/اغسطس.png', color: '#adaaad',     word: '',   sound: 'sounds/months/snd_august' },
		{ img: 'img/سبتمبر.png', color: '#f4f3bf',   word: '',   sound: 'sounds/months/snd_september' },
		{ img: 'img/اكتوبر.png', color: '#d1f5f7',   word: '',   sound: 'sounds/months/snd_october' },
		{ img: 'img/نوفمبر.png', color: '#f6cbc0',   word: '',   sound: 'sounds/months/snd_november' },
		{ img: 'img/ديسمبر.png', color: '#ebd792',   word: '',   sound: 'sounds/months/snd_december' }
