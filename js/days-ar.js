(function () {
    var games = [
	  ...
	  { img: 'img/days.png', color: '#ffffff',  word: '',   sound: 'sounds/colors/',caption:'',caption_Ar:'' ,voice:'' },
	  
	  	
       { img: 'img/days/monday.png', color: '#ccecfb',  word: '',  sound: 'sounds/days/snd_monday',caption:'أحمر' ,caption_Ar:'🔊', voice: 'sounds/days/snd_monday'},

	   { img: 'img/days/tuesday.png', color: '#ccecfb',  word: '',  sound: 'sounds/days/snd_tuesday',caption:'أزرق',caption_Ar:'🔊' , voice: 'sounds/days/snd_tuesday' },
		

	  { img: 'img/days/wednesday.png', color: '#ccecfb',  word: '',  sound: 'sounds/days/snd_wednesday',caption:'أخضر',caption_Ar:'🔊', voice: 'sounds/days/snd_wednesday' },


		  { img: 'img/days/thursday.png', color: '#ccecfb',  word: '',  sound: 'sounds/days/snd_thursday',caption:'أصفر',caption_Ar:'🔊' , voice: 'sounds/days/snd_thursday'},
		
		  { img: 'img/days/friday.png', color: '#ccecfb',  word: '',  sound: 'sounds/days/snd_friday',caption:'برتقالي',caption_Ar:'🔊', voice: 'sounds/days/snd_friday' },
		
	
		  { img: 'img/days/saturday.png', color: '#ccecfb',  word: '',  sound: 'sounds/days/snd_saturday',caption:'بنفسجي',caption_Ar:'🔊' , voice: 'sounds/days/snd_saturday'},
		
		 { img: 'img/days/sunday.png', color: '#ccecfb',  word: '',  sound: 'sounds/days/snd_sunday',caption:'أبيض',caption_Ar:'🔊', voice: 'sounds/days/snd_sunday' }
