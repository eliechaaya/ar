(function () {
    var games = [
	  ...
	  { img: 'img/months.png',   color: '#ffffff',  word: '',   sound: 'sounds/colors/',caption:'dog 🔊',caption_Ar:'' ,voice:'' },
	  
	  	
       { img: 'img/months/january.png', color: '#ffffff',  word: '',  sound: 'sounds/months/snd_january',caption:'يناير' ,caption_Ar:'يناير 🔊', voice: 'sounds/months/snd_january'},

		  { img: 'img/months/february.png', color: '#ffffff',  word: '',  sound: 'sounds/months/snd_february',caption:'فبراير',caption_Ar:'فبراير 🔊' , voice: 'sounds/months/snd_february' },
		

		  { img: 'img/months/march.png', color: '#ffffff',  word: '',  sound: 'sounds/months/snd_march',
		  caption:'مارس',caption_Ar:'مارس 🔊', voice: 'sounds/months/snd_march' },


		  { img: 'img/months/april.png', color: '#ffffff',  word: '',  sound: 'sounds/months/snd_april',
		  caption:'ابريل',caption_Ar:'ابريل 🔊' , voice: 'sounds/months/snd_april'},
		  
		  { img: 'img/months/may.png', color: '#ffffff',  word: '',  sound: 'sounds/months/snd_may',
		  caption:'مايو',caption_Ar:'مايو 🔊', voice: 'sounds/months/snd_may' },
		
		  { img: 'img/months/june.png', color: '#ffffff',  word: '',  sound: 'sounds/months/snd_june',
		  caption:'يونيو',caption_Ar:'يونيو 🔊', voice: 'sounds/months/snd_june' },
		
	
		  { img: 'img/months/july.png', color: '#ffffff',  word: '',  sound: 'sounds/months/snd_july',
		  caption:'يوليو',caption_Ar:'يوليو 🔊' , voice: 'sounds/months/snd_july'},
		
		 { img: 'img/months/august.png', color: '#ffffff', word: '',  sound: 'sounds/months/snd_august',
		  caption:'أغسطس',caption_Ar:'أغسطس 🔊', voice: 'sounds/months/snd_august' },
		
		  { img: 'img/months/september.png', color: '#ffffff',  word: '',  sound: 'sounds/months/snd_september',caption:'سبتمبر',caption_Ar:'سبتمبر 🔊' , voice: 'sounds/months/snd_september'},
		
          { img: 'img/months/october.png', color: '#ffffff',  word: 'dog',  sound: 'sounds/months/snd_october',caption:'اوكتوبر',caption_Ar:'اوكتوبر 🔊' , voice: 'sounds/months/snd_october'},
		  
		 { img: 'img/months/november.png', color: '#ffffff',  word: 'dog',  sound: 'sounds/months/snd_november',caption:'نوفمبر',caption_Ar:'نوفمبر 🔊' , voice: 'sounds/months/snd_november'},
		 
		  { img: 'img/months/december.png', color: '#ffffff',  word: 'dog',  sound: 'sounds/months/snd_december',caption:'ديسمبر',caption_Ar:'ديسمبر 🔊' , voice: 'sounds/months/snd_december'}
