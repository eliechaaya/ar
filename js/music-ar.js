(function () {
    var games = [
	  ...
	  { img: 'img/music.png', color: '#ffffff',  word: '',   sound: 'sounds/colors/',caption:'',caption_Ar:'🎼 آلات موسيقية 🎼' ,voice:'sounds/colors/' },
	  
	  	
       { img: 'img/music/piano.png', color: '#ffffff',   word: 'piano',  sound: 'sounds/music/piano',
	   caption:'بيانو' ,caption_Ar:'🔊 بيانو ♬', voice: 'sounds/music/piano1'},

	   { img: 'img/music/violin.png', color: '#ffffff',  word: 'violin',  sound: 'sounds/music/violin',
	   caption:'كمان',caption_Ar:'🔊 كمان ♬' , voice: 'sounds/music/violin1' },
		

	  { img: 'img/music/guitar.png', color: '#ffffff',  word: 'guitar',  sound: 'sounds/music/guitar',
	   caption:'قيثارة',caption_Ar:'🔊 قيثارة ♬', voice: 'sounds/music/guitar1' },
	   
      { img: 'img/music/trumpet.png', color: '#ffffff',  word: 'trumpet',  sound: 'sounds/music/trumpet',
	   caption:'بوق' ,caption_Ar:'🔊 بوق ♬', voice: 'sounds/music/trumpet1'}, 

	 { img: 'img/music/eguitar.png', color: '#ffffff',  word: 'eguitar',  sound: 'sounds/music/eguitar',
	   caption:'قيثارة كهربائية' ,caption_Ar:'🔊 قيثارة كهربائية ♬', voice: 'sounds/music/eguitar1'},
		
	{ img: 'img/music/oud.png', color: '#ffffff',  word: 'oud',  sound: 'sounds/music/oud',
	   caption:'عود' ,caption_Ar:'🔊 عود ♬', voice: 'sounds/music/oud1'},
	   
	{ img: 'img/music/nay.png', color: '#ffffff',  word: 'oud',  sound: 'sounds/music/nay',
	   caption:'ناي' ,caption_Ar:'🔊 ناي ♬', voice: 'sounds/music/nay1'},

	{ img: 'img/music/triangle.png', color: '#ffffff',  word: 'مثلث',  sound: 'sounds/music/triangle',
	   caption:'مثلث' ,caption_Ar:'🔊 مثلث ♬', voice: 'sounds/music/triangle1'},

	{ img: 'img/music/drum.png', color: '#ffffff',  word: 'طبل',  sound: 'sounds/music/drum',
	   caption:'طبل' ,caption_Ar:'🔊 طبل ♬', voice: 'sounds/music/drum1'},	

    { img: 'img/music/tabla.png', color: '#ffffff',  word: 'طبلة',  sound: 'sounds/music/tabla',
	   caption:'طبلة' ,caption_Ar:'🔊 طبلة ♬', voice: 'sounds/music/tabla1'},

    { img: 'img/music/bouzou.png', color: '#ffffff',  word: 'بزق',  sound: 'sounds/music/bouzou',
	   caption:'بزق' ,caption_Ar:'🔊 بزق ♬', voice: 'sounds/music/bouzou1'}, 	   
     
    { img: 'img/music/daff.png', color: '#ffffff',  word: 'دف',  sound: 'sounds/music/daff',
	   caption:'دف' ,caption_Ar:'🔊 دف ♬', voice: 'sounds/music/daff1'}
