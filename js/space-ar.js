(function () {
    var games = [
	  ...
	  { img: 'img/space.png', color: '#000000',  word: 'space',   sound: 'sounds/space/space',caption:'',caption_Ar:'' ,voice:'' },
	  
	  	
       { img: 'img/space/earth.png', color: '#ccecfb',  word: 'Earth',  sound: 'sounds/space/earth',
	   caption:'الأرض' ,caption_Ar:'🔊 الأرض', voice: 'sounds/space/earth',voice_en:'sounds/music/piano1'},
	   
	    { img: 'img/space/moon.png', color: '#ccecfb',  word: 'Earth',  sound: 'sounds/space/moon',
	   caption:'القمر' ,caption_Ar:'🔊 القمر', voice: 'sounds/space/moon',voice_en:'sounds/'},

	   { img: 'img/space/sun.png', color: '#ccecfb',  word: 'violin',  sound: 'sounds/space/sun',
	   caption:'الشمس',caption_Ar:'🔊 الشمس' , voice: 'sounds/space/sun' },
		

	  { img: 'img/space/jupiter.png', color: '#ccecfb',  word: 'guitar',  sound: 'sounds/space/jupiter',
	   caption:'المشتري',caption_Ar:'🔊 المشتري', voice: 'sounds/space/jupiter' },
	   
  	 { img: 'img/space/mars.png', color: '#ccecfb',  word: 'mars',  sound: 'sounds/space/mars',
	   caption:'المريخ' ,caption_Ar:'🔊 المريخ', voice: 'sounds/space/mars'},
		
	{ img: 'img/space/uranus.png', color: '#ccecfb',  word: 'uranus',  sound: 'sounds/space/uranus',
	   caption:'أورانوس' ,caption_Ar:'🔊 أورانوس', voice: 'sounds/space/uranus'},
	   
	{ img: 'img/space/neptune.png', color: '#ccecfb',  word: 'نبتون',  sound: 'sounds/space/neptune',
	   caption:'نبتون' ,caption_Ar:'🔊 نبتون', voice: 'sounds/space/neptune'},

	{ img: 'img/space/murcury.png', color: '#ccecfb',  word: 'عُطارد',  sound: 'sounds/space/mercury',
	   caption:'عُطارد' ,caption_Ar:'🔊 عُطارد', voice: 'sounds/space/mercury'},

	{ img: 'img/space/saturn.png', color: '#ccecfb',  word: 'زُحَلْ',  sound: 'sounds/space/saturn',
	   caption:'زُحَلْ' ,caption_Ar:'🔊 زُحَلْ', voice: 'sounds/space/saturn'},	

    { img: 'img/space/venus.png', color: '#ccecfb',  word: 'الزهرة',  sound: 'sounds/space/venus',
	   caption:'الزهرة' ,caption_Ar:'🔊 الزهرة', voice: 'sounds/space/venus'},

    { img: 'img/space/comet.png', color: '#ccecfb',  word: 'دف',  sound: 'sounds/space/comet',
	   caption:'مذنب' ,caption_Ar:'🔊 مذنب', voice: 'sounds/space/comet'},
	   
	   { img: 'img/space/asteroid.png', color: '#ccecfb',  word: 'دف',  sound: 'sounds/space/asteroid',
	   caption:'كويكب' ,caption_Ar:'🔊 كويكب', voice: 'sounds/space/asteroid'},

    { img: 'img/space/rocket4.gif', color: '#ccecfb',  word: 'دف',  sound: 'sounds/space/rocket',
	   caption:'صاروخ' ,caption_Ar:'🔊 صاروخ', voice: 'sounds/space/rocket'},
	  

 { img: 'img/space/astro.png', color: '#ccecfb',  word: 'دف',  sound: 'sounds/space/astro',
	   caption:'رائد فضاء' ,caption_Ar:'🔊 رائد فضاء', voice: 'sounds/space/astro'},	  
	   
	  { img: 'img/space/ship.png', color: '#ccecfb',  word: 'مركبة فضائية',  sound: 'sounds/space/ship',
	   caption:'مركبة فضائية' ,caption_Ar:'🔊 مركبة فضائية', voice: 'sounds/space/ship'},	  

	  { img: 'img/space/solar.png', color: '#ccecfb',  word: 'مركبة فضائية',  sound: 'sounds/space/solar',
	   caption:'النظام الشمسي' ,caption_Ar:'🔊 النظام الشمسي', voice: 'sounds/space/solar'}	   
